...
proc loadtclblend {dir} {
    ...
    # Prepend specific directories to the PATH before loading the
    # TclBlend shared library. This logic is Win32 specific.
    #
    # If installed into C:\TclBlend then these paths will be:
    #
    # C:\TclBlend\j2sdk1.4.2_15\jre\bin
    # C:\TclBlend\j2sdk1.4.2_15\jre\bin\client
    # C:\TclBlend\lib\tcljava1.4.1

    set root [file dirname [file dirname $dir]]
    set d1 [file join $root j2sdk1.4.2_15 jre bin]
    set d2 [file join $root j2sdk1.4.2_15 jre bin client]
    set d3 $dir

    set d1 [file nativename $d1]
    set d2 [file nativename $d2]
    set d3 [file nativename $d3]

    set env(PATH) "${d1}\;${d2}\;${d3}\;$env(PATH)"
